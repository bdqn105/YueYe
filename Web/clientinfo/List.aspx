<%@ Page Title="clientinfo" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="YueYePlat.Web.clientinfo.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="ClientName" HeaderText="ClientName" SortExpression="ClientName" ItemStyle-HorizontalAlign="Center"  /> 
