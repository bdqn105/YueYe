...
namespace Maticsoft.DBUtility
{
    ...
    public abstract class DbHelperMySQL
    {
        ...
        public static void UpdateConnectionString(string dbName)
        {
            MySqlConnection conn = new MySqlConnection(connectionString);
            MySqlConnectionStringBuilder builder = new MySqlConnectionStringBuilder();
            builder.Database = dbName;
            builder.Server = conn.DataSource;
            builder.UserID=ConfigurationManager.AppSettings["uid"].ToString();
            builder.Password = ConfigurationManager.AppSettings["upwd"].ToString();
