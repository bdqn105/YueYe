...
namespace YueYePlat.DAL
{
	...
	public partial class usercontrolinfo
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("Id", "usercontrolinfo"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from usercontrolinfo");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from usercontrolinfo ");
			strSql.Append(" where Id=@Id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@Id", MySqlDbType.Int32)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,UserControlId,UserControlName ");
			strSql.Append(" FROM usercontrolinfo ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from usercontrolinfo T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "usercontrolinfo";
